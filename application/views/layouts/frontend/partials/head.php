...
<head>
    ...
    <title><?= $title ?></title>
    <link rel="icon" href="<?= site_url('assets/images/logo_icon.png') ?>" type="image/x-icon">
    <link rel="shortcut icon" href="<?= site_url('assets/images/logo_icon.png') ?>" type="image/x-icon">
