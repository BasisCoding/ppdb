...
<script>
    ...
    $(document).ready(function() {
        ...
        table = $('#table-jurusan').DataTable({
            ...
            "ajax": {
                "url": "<?= base_url('data-jurusan/store')?>",
                "type": "POST"
            },
    ...
    // BTN Action Modal
        ...
        $('#table-jurusan').on('click', '.btn-update', function(event) {
            event.preventDefault();
			...
			$('[name="nama_jurusan_update"]').val(nama);
			$('[name="slug_jurusan_update"]').val(slug);
        });


        $('#table-jurusan').on('click', '.btn-delete', function(event) {
            event.preventDefault();
            var id = $(this).attr('data-id');
        ...
        function send(formData, nameAction) {
            $.ajax({
                url: '<?= base_url("data-jurusan/") ?>'+nameAction+'',
                type: 'POST',
                dataType: 'JSON',
                data: formData,
                processData: false,
